...
kable(x_regsea, caption=paste(yrs[1], "-", yrs[n], "statistical summary of", ifelse(nrow(x_regsea)==1, "the", ""), 
                           "spatial", varname, ifelse(nrow(x_regsea)==1, "distribution.", "distributions.")),
      digits=rnd)
```
...
kable(x_oneregsea, caption=paste(yrs[n], "spatial", varname, "statistical summary."), digits=rnd)
```
...
kable(x_decregsea, caption=paste(yrs[1], "-", yrs[n], "statistical summary of", ifelse(nrow(x_decregsea)==1, "the", ""), 
                           "spatial", varname, ifelse(nrow(x_decregsea)==1, "distribution.", "distributions.")),
      digits=rnd)
```
